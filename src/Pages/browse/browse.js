            ...
            >
              <div className="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col border-none bg-black bg-clip-padding text-current shadow-lg outline-none bg-black">
                ...
                <div className="flex flex-shrink-0 flex-wrap items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                  <button
                    type="button"
                    className="inline-block  px-6 pb-2 pt-2.5 text-lg font-medium uppercase leading-normal text-white  "
                    data-te-modal-dismiss
                    data-te-ripple-init
                    data-te-ripple-color="light"
                    onClick={() => {
                  ...
                  >
                    {t("clear-smallDivices")}
                  </button>
                </div>
              </div>
            </div>
          </div>
          <div className="flex lg:my-10 sm:w-full sm:ml-0 md:ml-0 md:w-full  lg:w-4/5 lg:ml-20 xl:ml-40 p">
