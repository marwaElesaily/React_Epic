const Modal = (props) => {
  return (
    <div>
      ...
      <div
        // data-te-modal-init
        class="fixed top-0 left-0 z-[1055] hidden h-full w-full  overflow-x-hidden outline-none"
        id={props.id}
        tabindex="-1"
      ...
      >
        ...
        >
          <div class="pointer-events-auto relative flex max-h-[100%] w-full flex-col overflow-hidden rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
            ...
            <div class="relative overflow-y-auto p-4 bg-white">
              <p>wqeqwewq</p>
            </div>
            <div class="flex   items-center justify-end rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
              <button
                type="button"
